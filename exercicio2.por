programa {
  funcao inicio() {
    ...
    se (salariomensal>= piso)
      escreva(" Seu salario mensal é de: " + salariomensal,"\n Seu salario esta de acordo com o piso" )
      senao(escreva(" Seu salario mensal é de: " + salariomensal,"\n Seu salario não está de acordo com o piso"))
